...
class Ssv2(torch.utils.data.Dataset):
    ...
    def __init__(self, cfg, mode, num_retries=10):
        """
        Construct the Something-Something-V2 video loader with a given csv file. The format of
        the csv file is:
        ```
    ...
    def _construct_loader(self):
        ...
        ), "Failed to load Something-Something v2 split {} from {}".format(
