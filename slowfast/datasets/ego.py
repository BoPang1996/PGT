...
class Ego(torch.utils.data.Dataset):
    """
    CharadesEgo video loader. Construct the CharadesEgo video loader, then sample
    ...
    def __init__(self, cfg, mode, num_retries=10):
        """
        Load CharadesEgo data (frame paths, labels, etc.) to a given Dataset object.
        ...
        assert mode in [
            ...
            "val",
            "test",
        ], "Split '{}' not supported for CharadesEgo".format(mode)
        self.mode = mode
        self.cfg = cfg
        ...
        logger.info("Constructing CharadesEgo {}...".format(mode))
    ...
    def _construct_loader(self):
        ...
        logger.info(
            "CharadesEgo dataloader constructed (size: {}) from {}".format(
